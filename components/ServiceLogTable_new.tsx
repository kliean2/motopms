...
// Total available width minus content padding (20px each side) and table borders
const availableWidth = screenWidth - 40 - 2; // Account for content padding and table border
const COLUMN_WIDTHS = {
    date: availableWidth * 0.20,        // 20%
    procedure: availableWidth * 0.40,    // 40% (larger for procedure + notes)
    odometer: availableWidth * 0.20,     // 20%
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContainer}>
                        ...
                        {/* Main Input (Procedure or other field) */}
                        <TextInput
                        ...
                        {/* Notes Input (only for procedure editing) */}
